...
'''I created a small program that stores grade information, 
 processes them to obtain the total grade and percentage, and does some 
 operations to prepare this information before printing them on screen.'''

'''Additional ways to play with:
