password_length = 6
counter = 1
# counts number of time we enter the loop
permutations = 1
# counts the number of possible combinations of the character.
...
# Now we set how many attempts till locked and how long for
attempts = 5
...
# Setting locking time depending on how many times account was locked before
locks = 0
total_lock_time = 0
lock_time_multiplier = 5

for locks in range(max_lock):
  locks += 1
...
# You can change the while loop to a for loop and vice versa 
# include a different length for the password, 
# or try playing around with other data types.
